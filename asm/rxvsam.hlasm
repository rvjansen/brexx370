RXVSAM   TITLE 'REXX/VSMIO API'                                         00000100
* --------------------------------------------------------------------- 00000200
*   API TO VSMIO (STEVE SCOTT), CALLED FROM C (FOR BREXX)               00000300
*   AUTHOR  : PETER JACOB (PEJ)                                         00000400
*   CREATED : 06.08.2019  PEJ                                           00000500
...
*        DDNAMEVPREFIX      #=  0C1 AFTER RETURNING FROM VSIOMOD
         PRINT GEN                                                      00000800
* --------------------------------------------------------------------  00000900
*   INTERNAL MACRO DEFINITIONS                                          00000300
* --------------------------------------------------------------------  00001100
         MACRO
...
* RXVSAM MAIN PROGRAM
* --------------------------------------------------------------------
RXVSAM   MRXSTART A2PLIST=YES                                           00001200
...
**********************************************************************
VS$#@LST DS    A
VSIOMOD  DC    CL8'IRXVSMIO'
VSIOMODT DC    CL8'IRXVSMTR'
         LTORG
* --------------------------------------------------------------------  00002300
