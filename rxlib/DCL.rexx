 ...
 *    $DEFINE/$INIT  Initialise the structure
...
dcl:
  ...
  _ivi=$dcldef._dclname.$vname.0+1
  $dcldef._dclname.$vname.0=_ivi
  _ftype=substr(_ftype,1,1)
  _nxt=_off+_len
  _ff=$actveprf''_field
/* keep the definition fields, special request by Johan  */
  $dcldef._dclname.$vname._ivi=_ff
  $dcldef._dclname.$offset._ivi=_off
  $dcldef._dclname.$length._ivi=_len
  $dcldef.$actvedcl.$set=,
